...
export function AddPackagingTypeModal({ open, onOpenChange, onSubmit, submitting = false }: Props) {
    ...
    <Dialog open={open} onOpenChange={(v) => { if (!v && !submitting) { reset(); onOpenChange(v); } }}>
      <DialogContent className="sm:max-w-md rounded-2xl p-6 gap-0">
        <DialogHeader className="mb-1">
          <DialogTitle className="text-xl font-bold text-slate-800">Add New Packaging Type</DialogTitle>
